 ...
 * Select Component
 * 
 * A styled select dropdown component that matches shadcn/ui design patterns.
 * This is a simple implementation that works well for our use case.
 */
